...
<template>
  <div
    ...
    :class="isOver ? 'border-emerald-400 bg-emerald-400/5' : 'border-neutral-700 bg-neutral-900/40'"
    role="button"
    tabindex="0"
    @click="pick"
    ...
    @drop.prevent="onDrop"
  >
    <svg class="h-10 w-10 text-neutral-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    ...
    <p class="text-sm text-neutral-300">
      {{ t('dropzone.dragHint') }} <span class="font-medium text-emerald-400">{{ t('dropzone.browse') }}</span>
    </p>
